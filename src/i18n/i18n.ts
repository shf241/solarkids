...
const FALLBACK_TRANSLATIONS: TranslationData = {
  "zh-CN": {
    ...
    "welcome.description": "和太阳、月球与八大行星一起出发，探索会运动的宇宙课堂。",
    "welcome.feature.orbits": "观察天体运行",
    "welcome.feature.visit": "探访行星",
    "welcome.feature.phenomena": "探索天文现象",
    "welcome.loading": "正在准备太阳系…",
    "welcome.hint": "点击按钮，开始你的太空旅程",
    "action.start": "开始探索",
    "action.play": "继续",
    "action.pause": "暂停",
    "action.reset": "重置",
    ...
    "hint.dragPlanet": "拖动行星，观察轨道怎么变化。",
    "game.title": "轨道探索",
    "game.instruction": "拖一拖行星，看看轨道会怎样变化。",
    "game.change.stable": "行星还在原来的轨道附近。",
    "game.change.small": "轨道发生了一点变化。",
    "game.change.large": "轨道发生了明显变化！",
    "game.score": "得分",
    "game.saved": "本次结果已保存",
    "game.best": "最佳",
    ...
    "scene.orbit-game.title": "轨道探索小游戏",
    "scene.orbit-game.description": "拖动地球，观察轨道变化。",
  ...
  en: {
    ...
    "welcome.description": "Set off with the Sun, Moon, and eight planets in a living space classroom.",
    "welcome.feature.orbits": "Watch Orbits",
    "welcome.feature.visit": "Visit Planets",
    "welcome.feature.phenomena": "Explore Space",
    "welcome.loading": "Preparing the solar system…",
    "welcome.hint": "Press the button to begin your space journey",
